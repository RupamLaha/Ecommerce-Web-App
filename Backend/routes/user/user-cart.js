...
// /user/cart/check/
// check if a particular product is present in user cart or not...
router.get('/check/:userid/:prodid', (req, res) => {

    let query = `select * from cart where userid = '${req.params.userid}' and prodid = '${req.params.prodid}'`;
